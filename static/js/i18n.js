const TRANSLATIONS = {
  ...
  ar: {
    ...
    /* عام */
    leaderboard_title:"المتصدرون",leaderboard_empty:"لا يوجد أعضاء.",leaderboard_error:"تعذّر تحميل قائمة المتصدرين. حدّث الصفحة وحاول مجددًا.",leaderboard_page_desc:"كل الأعضاء مرتبين حسب المستوى.",leaderboard_you:"أنت",leaderboard_pages_aria:"صفحات المتصدرين",trending_title:"الرائجة",follow_btn:"متابعة",unfollow_btn:"إلغاء",back:"رجوع",no_bio:"لا توجد نبذة.",mobile_switch_account:"تبديل",mobile_add_account:"إضافة حساب",mobile_logout:"خروج",open_post:"فتح المنشور",open_clip:"فتح المقطع",joined:"انضم",location_label:"الموقع",website_label:"الموقع الإلكتروني",
    /* الأمان */
