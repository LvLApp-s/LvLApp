...
20. `migrations/017_reel_bookmarks.sql`
21. `migrations/018_terms_acceptance.sql`
...
- `migrations/017_reel_bookmarks.sql` adds the first-class reel bookmarks table for saving clips.
- `migrations/018_terms_acceptance.sql` records the accepted Terms & Conditions revision per account and adds case-insensitive unique indexes for username/nickname.
